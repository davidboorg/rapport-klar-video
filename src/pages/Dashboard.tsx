    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="interactive-card border-2 border-accent-400/30 bg-white col-span-full lg:col-span-2">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-black">Starta ditt första projekt</h3>
          ...
          <Card className="interactive-card bg-white border-neutral-200">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-black mb-2">Mina Projekt</h3>
                <p className="text-sm text-neutral-600 mb-4">Hantera dina befintliga projekt</p>
                <Button variant="outline" size="sm" className="w-full border-brand-300 text-brand-600 hover:bg-brand-50">
                  Visa alla
                </Button>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="interactive-card group bg-white border-neutral-200">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-2">Video Mallar</h3>
          ...
          <Card className="interactive-card group bg-white border-neutral-200">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-2">Avatarer</h3>
                <p className="text-sm text-neutral-600 mb-4">Skapa AI-avatarer för videor</p>
                <Button variant="ghost" size="sm" className="text-success-600 hover:text-success-700 hover:bg-success-50">
                  Hantera avatarer
                </Button>
              </div>
            </CardContent>
          ...
          <Card className="interactive-card group bg-white border-neutral-200">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-2">Inställningar</h3>
                <p className="text-sm text-neutral-600 mb-4">Anpassa ditt konto</p>
                <Button variant="ghost" size="sm" className="text-neutral-600 hover:text-neutral-700 hover:bg-neutral-100">
                  Konfigurera
                </Button>
              </div>
            </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-white border-neutral-200">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-black">0 MB</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Recent Projects */}
          <Card className="h-fit bg-white border-neutral-200">
            <CardHeader>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-black mb-2">Inga projekt ännu</h3>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-neutral-200">
                  ...
                  <Badge className="bg-brand-100 text-brand-700">Gratis Provperiod</Badge>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-neutral-200">
                  <span className="text-sm font-medium text-neutral-600">Plan</span>
                  <span className="text-sm text-black font-medium">Starter</span>
                </div>
